...
<section class="py-5" id="features">
    <div class="container px-5 my-5">
        <div class="row gx-5">
            <div class="col-lg-8 card p-4 mx-auto mb-5 mb-lg-0">
                <h1><?php echo $title; ?></h1>
                <p class="lead"><?php echo \App\App::config('site_name'); ?> is a minimal PHP framework designed to help you build web applications quickly and efficiently. It includes essential features like routing, controllers, and views, allowing you to focus on your application's logic without worrying about the underlying infrastructure.</p>
