...
if (!class_exists('App\\User')) {
    ...
    echo 'Check that composer.json, autoload, and namespaces are correct.<br>';
...
// --- End autoload sanity check ---

use App\DB;
use App\User;
$requestPath = '/' . trim(parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH), '/');
if ($requestPath === '/install') {
    // Serve the installer page directly
    require_once __DIR__ . '/views/install.php';
    exit;
}


// (Autoloader already required above)
