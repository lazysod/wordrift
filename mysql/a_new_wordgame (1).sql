...
--
-- Host: localhost:8889
-- Generation Time: Jul 27, 2025 at 03:30 PM
...
INSERT INTO `game_results` (`id`, `user_id`, `game_date`, `mode`, `result`, `guesses`, `answer`, `guess_history`, `created_at`) VALUES
(1, 1, '2025-07-27', 'daily', 'win', 1, 'GROPE', '[]', '2025-07-27 15:31:58');
...
(1, NULL, 'Customer', 0, 0),
(2, NULL, 'Admin', 100, 1),
(3, NULL, 'THC Staff', 20, 0),
(4, NULL, 'Medical Staff', 5, 0),
(5, NULL, 'Optician', 5, 0),
(6, NULL, 'Dentist', 5, 0),
(7, NULL, 'Therapist', 5, 0);
...
INSERT INTO `reset` (`id`, `user_id`, `key`, `date`) VALUES
(36, 2, '9bc16268f490f03159ea7bd463a593e5b383ba08', '2023-06-20 08:42:04');
...
INSERT INTO `users` (`id`, `display_name`, `email`, `pwd`, `location`, `security_hash`, `avatar`, `rank`, `last_access`, `active`, `date`, `dead_switch`, `avatar_color`, `correct_answers_count`, `reputation_points`) VALUES
(1, 'Lazysod', 'divinorum2001@gmail.com', '$2y$12$AVOTtNsK6THpWp86ds2.2ekULICrVZ3yJ9UVG5zjwQsgCF1QjYuPK', NULL, 'eadee2397845d6a762b373238264fe14', 'app/uploads/users/avatar/1/smile.png', 1, '2025-07-27 13:28:05', 1, NULL, 0, 'indigo', 0, 0),
(5, 'testing shit', 'ghostwalker2011@gmail.com', '$2y$12$vfeLPDrPeagEmxUiuHUgneIS.8afFIlPBEx5A29tjGhd8QkQR97A.', NULL, '$2y$12$6QHLe.5T4Z9Ux9AfYjy03OB/.bFnnPTs4x4id7sM4zg4qZ7AHsQm.', 'assets/images/blank_user.png	', 0, '2025-07-26 14:08:26', 1, '2025-06-17', 0, NULL, 10, 20),
(7, 'albaweb', 'admin@albaweb.net', '$2y$12$0hY.dRZo5q4aUhHfQ6ShrOCUC/iyfK9CNhMG9zvyvCQ5tWLYIaK9e', NULL, '$2y$12$PjI2LdUoNQ69IsXRnXaDNO9OAPOu2ZBD1OP3FCAA5BxsOqvwtc0J2', 'app/img/default.png', 0, '2025-07-22 12:24:16', 1, '2025-07-22', 0, NULL, 0, 0);
...
--
ALTER TABLE `word_list`
  MODIFY `word_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2316;
