...
function showCookieBanner() {
  ...
  if (getCookie("cookie_consent") !== "1") {
    ...
    banner.innerHTML =
      'This website uses cookies to ensure you get the best experience. <button id="cookie-consent-accept" style="margin-left:16px;" class="btn btn-primary btn-sm">Accept</button>';
